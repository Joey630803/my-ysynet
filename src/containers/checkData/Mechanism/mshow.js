...
import { Breadcrumb, Form,Row,Col,Upload, Input,Button, BackTop,message,Modal,Select} from 'antd';
...
class MechanismDetails extends React.Component {
  state = {
    loading: false,
    visible: false,
    ...
    return (
      <div>
        <Breadcrumb style={{fontSize: '1.1em'}}>
          ...
          <Breadcrumb.Item>医疗机构详情</Breadcrumb.Item>
        </Breadcrumb>
        <Row>
         ...
         <Form style={{marginTop: '16px'}}>
          ...
          >
           {
              state.zyxkPath===""||state.zyxkPath===undefined?"":
              (
                  <Upload name="zyxkPath" 
                          ...
                          defaultFileList={[{
                            ...
                            name: 'zyxkPath',
                            status: 'done',
                            url: pathConfig.YSYPATH+state.zyxkPath,
                          }
                        ]}
                        >
                </Upload>
...
module.exports = MechanismDetails;