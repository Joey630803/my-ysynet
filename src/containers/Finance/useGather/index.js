...
class SearchForm extends React.Component{
    ...
    getData = (query)=>{
        fetchData(finance.FINDUSERGATHER,querystring.stringify(query),(data)=>{
            if(data.status){
...
class UseGather extends React.Component{
    state = {
        dataSource: [],
        storageGuid:''
    }
