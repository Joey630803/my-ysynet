...
class OperDetail extends React.Component{
    state = {
        dataSource: [],
        totalPrice: '',
        hisPrice: ''
    ...
    componentDidMount = () =>{
        if(this.props.location.state.chargeGuid){
    ...
    total = ()=>{
        ...
        dataSource.forEach((item,index)=>{
            ...
            price.tenderTotal += amount*item.tenderPrice;
    ...
    render(){
        ...
        const exportHref = department.EXPORTCHARGEDETAIL+"?"+querystring.stringify({
            chargeGuid:this.props.location.state.chargeGuid,chargeType:'00',
                        ...
                        <Col className="ant-col-18">
                            <div className="ant-row">
                                ...
                                <div className="ant-col-22">
                                    <div className="ant-form-item-control">
                                        { baseData.operNo+"|"+baseData.operName }
                                    </div>
                                </div>
                            </div>
                        </Col>
