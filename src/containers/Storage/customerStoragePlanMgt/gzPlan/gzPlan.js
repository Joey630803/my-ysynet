...
class GzPlanMgt extends React.Component{
    state = {
        query :{},
        selected: [],
        selectedRows: [],
        ...
        const columns = [{
            ...
            render : (text,record)=>{
                return <span>
                    <a onClick={
                    actionHandler.bind(
                        null, this.props.router,`/storage/customerStoragePlanMgt/gzPlan/showGz`, {...record}
                    )}>
                   详情
                </a>
                {
                    ...
                    <span>
                        ...
                        <a onClick={
                        actionHandler.bind(
                            null, this.props.router,`/storage/customerStoragePlanMgt/gzPlan/editGzPlan`, {...record}
                        )}>编辑</a>
                    </span>
                    :null
                }
            ...
            <div>
                ...
                <div>
                    ...
                    onClick={  actionHandler.bind(
                        null, this.props.router, `/storage/customerStoragePlanMgt/gzPlan/addGzPlan`, { }
                    )}>
                    添加
                    </Button>
                    <Button 
