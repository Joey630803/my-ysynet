...
class OrderDetails extends React.Component {
  state = {
    ...
    componentDidMount = () => {
        //根据订单id查询产品列表
        fetchData(purchase.DETAILS_BY_ORDERID,querystring.stringify({orderId:this.props.location.state.orderId}),(data)=>{
          this.setState({productDataSource: data.result})
        })
         //根据订单id查询送货单信息
         fetchData(purchase.DELIVERYLIST,querystring.stringify({orderId:this.props.location.state.orderId}),(data)=>{
